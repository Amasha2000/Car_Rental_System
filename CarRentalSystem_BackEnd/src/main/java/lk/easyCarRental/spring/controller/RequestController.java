...
public class RequestController {
    ...
    public ResponseEntity postRequest(@RequestBody RequestDTO dto) {
        ...
        return new ResponseEntity(new ResponseUtil(200, "Request has been sent", dto), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity uploadBankSlip(@RequestPart("bankSlip") MultipartFile image) {
        try {
            ...
            Path path = Paths.get("/Users/Amasha/Desktop/easyCarRentalStorage/bankslip/");
    ...
    public void getBankSlipImage(@PathVariable String image, HttpServletResponse response) throws IOException {
        ...
        String path = "/Users/Amasha/Desktop/easyCarRentalStorage/bankslip/";
    ...
    public ResponseEntity getLastRid() {
        ...
        return new ResponseEntity(new ResponseUtil(200, "Done", lastRid), HttpStatus.OK);
    }
    ...
    public ResponseEntity getRequestByCid(String cid) {
        ...
        return new ResponseEntity(new ResponseUtil(200, "Done", request), HttpStatus.OK);
    }
    ...
    public ResponseEntity test() {
        ArrayList<CustomDTO> test = requestService.test("V001");
        return new ResponseEntity(new ResponseUtil(200, "Done", test), HttpStatus.OK);
    }
